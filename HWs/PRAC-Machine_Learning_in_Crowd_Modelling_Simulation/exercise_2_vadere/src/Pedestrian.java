...
public class Pedestrian extends Agent {
    ...
    private int totalInfectedPedestrians = 0;
    ...
    // Getter
    public int getTotalInfectedPedestrians() { return this.totalInfectedPedestrians; }
    ...
    // Setter
    public void setTotalInfectedPedestrians(int totalInfectedPedestrians) { this.totalInfectedPedestrians = totalInfectedPedestrians; }
