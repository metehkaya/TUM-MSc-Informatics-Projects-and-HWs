...
public class DefaultSimulationConfig extends DefaultConfig {
	...
	protected final Color pedestrianSusceptibleColor = new Color(50, 200, 50);

	protected final Color pedestrianInfectedColor = new Color(200, 50, 50);

	protected final Color pedestrianRecoveredColor = new Color(50, 50, 200);
	...
	public Color getPedestrianSusceptibleColor() {
		return pedestrianSusceptibleColor;
	}

	public Color getPedestrianInfectedColor() {
		return pedestrianInfectedColor;
	}

	public Color getPedestrianRecoveredColor() {
		return pedestrianRecoveredColor;
	}
